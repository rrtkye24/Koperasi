...
<html>
    <head>
        ...
        @endphp
        <meta charset="utf-8" />
        <title>Sistem Informasi Koperasi Karyawan SMK Bagimu Negeriku</title>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" class="img-fluid logo-img" href="{{ '../images/logo.png' }}">
        <!-- CSRF Token -->
                                    ...
                                    <div class="account-logo-box">
                                        <h2 class="text-uppercase text-center">
                                            <a href="{{ url('/') }}" class="text-success">
                                                <span><img class="img-fluid logo-img" src="{{'../images/logo.png' }}" alt="" width="90"></span>
                                            </a>
                                        </h2>
                                        <h6 class="text-uppercase text-center font-bold mt-4">
                                            Welcome to Koperasi Bagimu Negeriku 
                                        </h6>
                                        <h6 class="text-uppercase text-center font-bold 
                                        ">
                                            Login 
                                        </h6>
                                    </div>
